...
public class AutonomousCone extends Autonomous{
    ...
    public AutonomousCone(Drive robotDrive, Hood aimer, Shooter shooter, SpeedController kicker, SpeedController hopper,
        ...
        m_firstTrajectory = TrajectoryGenerator.generateTrajectory(new Pose2d(0, 0, new Rotation2d(0)), List.of(/*new Translation2d(1.524, 1.524)*/), new Pose2d(1.524, 1.524, new Rotation2d(-(Math.PI / 2))), forwardConfig);
